    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="container-wide section-padding flex flex-col items-center justify-center min-h-screen relative z-10">
        ...
        <motion.p
          ...
          Aprenda, em duas semanas, a regular emoções e reduzir o caos interno com consciência e autonomia, usando um método prático de integração com o corpo, psique e espiritualidade.
