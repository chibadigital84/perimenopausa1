...
const modules = [{
  ...
  topics: ['Ressignifique a perimenopausa como uma transição positiva', 'Entenda por que tantas mulheres se sentem "perdidas"', 'Descubra a visão espiritual da transição feminina']
}, {
  number: 2,
  icon: Heart,
  title: 'O corpo fala: hormônios, emoções e sensibilidade',
  topics: ['Como hormônios instáveis impactam mood, ansiedade e sono', 'Por que sua sensibilidade emocional aumentou', 'A diferença entre "estar desequilibrada" e "estar em transição"']
}, {
  number: 3,
  icon: BookHeart,
  title: 'Emoções sem julgamento: acolher para transformar',
  topics: ['Pare de se julgar e comece a se escutar', 'Emoções como mensageiras (não inimigas)', 'Diário emocional como ferramenta de clareza']
}, {
  number: 4,
  icon: Flower2,
  title: 'Ritual diário de autocuidado',
  topics: ['Por que pequenos rituais mudam seu estado emocional', 'Autocuidado como ato de maturidade (não egoísmo)', 'Exemplos práticos de rituais de 5-15 minutos']
}, {
  number: 5,
  icon: Wind,
  title: 'A mente desacelera quando o corpo respira',
  topics: ['Regule seu sistema nervoso e diminua ondas de calor', 'Como mindfulness atua no corpo hormonal', 'Técnicas para melhorar sono e humor']
}, {
  number: 6,
  icon: Sun,
  title: 'Espiritualidade madura: conexão sem culpa',
  topics: ['Reconecte-se à sua espiritualidade interna', 'Menos busca externa, mais escuta interna', 'Intuição, ciclos, silêncio e sabedoria corporal']
}, {
  number: 7,
  icon: Users,
...
export const ModulesSection = () => {
  return <section className="section-padding gradient-section-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          once: true
              ...
              <ul className="space-y-2">
                {module.topics.map((topic, i) => <li key={i} className="flex items-start gap-2 text-sm font-body text-muted-foreground">
